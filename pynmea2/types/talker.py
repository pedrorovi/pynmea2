...
class APB(TalkerSentence):
    ...
    fields = (
        ...
        (
            "Bearing to destination, type",
            "bearing_pres_dest_type",
        ),  # M = Magnetic, T = True
...
class RTE(TalkerSentence):
    ...
    fields = (
        ...
        (
            "Start Type",
            "start_type",
        ),  # The first in the list is either current route or waypoint
...
class TTM(TalkerSentence):
    ...
    fields = (
        ...
        (
            "Distance Units",
            "dist_unit",
        ),  # K / N / S (Kilometers / Knots / Statute miles)
        ("Target Name", "name"),
        (
            "Target Status",
            "status",
